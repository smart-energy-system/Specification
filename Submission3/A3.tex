...
Since our optimiser is not strong enough to solve variable shifting for every time step, we decided to allow the optimiser only to shift one time for a home with the constraints shown in \Cref{eq:numberOfShifts}.
